...
class GUI:
    def __init__(self, window):
        ...
        self.volumeUpButton.pack(side="right", padx=30)
        self.channelUpButton.pack(side="left", padx=30)
        self.frame_up.pack(anchor="n", pady=15)
        ...
        self.volumeDownButton.pack(side="right", padx=30)
        self.channelDownButton.pack(side="left", padx=30)
        self.frame_down.pack(anchor="n")        
